...
class SequelizeInstanceMethodsCaching {
  ...
  static buildInstanceMethodsForCaching(cacheClient, instance) {
    return {
      ...
      save() {
        return instance.save.apply(instance, arguments).then((instance) => {
          CachingUtils.save(cacheClient, instance);
        });
      },

      update() {
        return instance.update.apply(instance, arguments).then((instance) => {
          CachingUtils.save(cacheClient, instance);
        });
      },
...
module.exports = SequelizeInstanceMethodsCaching;
